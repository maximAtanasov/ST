...
ST::asset_file_type ST::get_file_extension(const std::string &filename) {
    if (filename.size() > 4) {
        ...
        if (filename.at(size - 3) == '.' && filename.at(size - 2) == 'p' && filename.at(size - 1) == 'n' &&
            filename.at(size) == 'g') {
            return ST::asset_file_type::PNG;
        } else if (filename.at(size - 3) == '.' && filename.at(size - 2) == 'w' && filename.at(size - 1) == 'a' &&
                   filename.at(size) == 'v') {
            return ST::asset_file_type::WAV;
        } else if (filename.at(size - 3) == '.' && filename.at(size - 2) == 'm' && filename.at(size - 1) == 'p' &&
                   filename.at(size) == '3') {
            return ST::asset_file_type::MP3;
        } else if (filename.at(size - 3) == '.' && filename.at(size - 2) == 'o' && filename.at(size - 1) == 'g' &&
                   filename.at(size) == 'g') {
            return ST::asset_file_type::OGG;
        } else if (filename.at(size - 3) == '.' && filename.at(size - 2) == 'b' && filename.at(size - 1) == 'i' &&
                   filename.at(size) == 'n') {
