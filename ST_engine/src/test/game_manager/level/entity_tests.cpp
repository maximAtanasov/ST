...
TEST(entity_tests, test_entities_collision){
    ...
    test_subject1.set_x(0);
    test_subject1.set_y(0);
    test_subject1.set_collision_box(0, 0, 100, 100);

    test_subject2.set_x(50);
    test_subject2.set_y(0);
...
TEST(entity_tests, test_entities_not_colliding_on_edge){
    ...
    test_subject2.set_x(100);
    test_subject2.set_y(100);
    test_subject2.set_collision_box(0, 0, 100, 100);
...
TEST(entity_tests, test_entities_colliding_one_pixel_from_edge){
    ...
    test_subject2.set_x(99);
    test_subject2.set_y(99);
    test_subject2.set_collision_box(0, 0, 100, 100);
