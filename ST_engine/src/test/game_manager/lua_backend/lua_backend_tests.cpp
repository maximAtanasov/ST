...
TEST_F(lua_backend_test, test_call_function_createEntity){
    ...
    ASSERT_EQ(1, game_mngr->get_level()->entities.at(0).sprite_num);
    ASSERT_EQ(1, game_mngr->get_level()->entities.at(0).animation_num);
    ASSERT_EQ(1, game_mngr->get_level()->entities.at(0).animation);
...
TEST_F(lua_backend_test, test_call_function_entityCollides){
    ...
    ASSERT_EQ(1, game_mngr->get_level()->entities.at(1).sprite_num);
    ASSERT_EQ(1, game_mngr->get_level()->entities.at(1).animation_num);
    ASSERT_EQ(1, game_mngr->get_level()->entities.at(1).animation);
